...
namespace Ionic.Zip
{
  ...
  public class ZipFile : IEnumerable<ZipEntry>, IEnumerable, IDisposable
  {
      ...
      if (!this._addOperationCanceled)
      {
        ...
        if (recurse)
        {
          ...
          if (!this._addOperationCanceled)
          {
            ...
            {
              FileAttributes attributes = (FileAttributes) NetCfFile.GetAttributes(directory);
        ...
        foreach (ZipEntry zipEntry1 in zipFile1)
        {
          foreach (ZipEntry zipEntry2 in zipFile2)
          {
            if (zipEntry1.FileName == zipEntry2.FileName)
            {
              ...
              {
                flag = false;
                writer?.WriteLine("{0}: mismatch in RelativeOffsetOfLocalHeader  (0x{1:X16} != 0x{2:X16})", new object[3]
                {
                  (object) zipEntry1.FileName,
                  (object) zipEntry1._RelativeOffsetOfLocalHeader,
                  (object) zipEntry2._RelativeOffsetOfLocalHeader
                });
              }
              if (zipEntry1._CompressedSize != zipEntry2._CompressedSize)
              {
                flag = false;
                writer?.WriteLine("{0}: mismatch in CompressedSize  (0x{1:X16} != 0x{2:X16})", new object[3]
                {
                  (object) zipEntry1.FileName,
                  (object) zipEntry1._CompressedSize,
                  (object) zipEntry2._CompressedSize
                });
              }
              if (zipEntry1._UncompressedSize != zipEntry2._UncompressedSize)
              {
                flag = false;
                writer?.WriteLine("{0}: mismatch in UncompressedSize  (0x{1:X16} != 0x{2:X16})", new object[3]
                {
                  (object) zipEntry1.FileName,
                  (object) zipEntry1._UncompressedSize,
                  (object) zipEntry2._UncompressedSize
                });
              }
              if (zipEntry1.CompressionMethod != zipEntry2.CompressionMethod)
              {
                flag = false;
                writer?.WriteLine("{0}: mismatch in CompressionMethod  (0x{1:X4} != 0x{2:X4})", new object[3]
                {
                  (object) zipEntry1.FileName,
                  (object) zipEntry1.CompressionMethod,
                  (object) zipEntry2.CompressionMethod
                });
              }
              if (zipEntry1.Crc != zipEntry2.Crc)
              {
                ...
                if (writer != null)
                {
                  writer.WriteLine("{0}: mismatch in Crc32  (0x{1:X4} != 0x{2:X4})", new object[3]
                  {
                    (object) zipEntry1.FileName,
                    (object) zipEntry1.Crc,
                    (object) zipEntry2.Crc
                  });
                  break;
                }
                break;
    ...
    {
      get => this.\u003CFullScan\u003Ek__BackingField;
      set => this.\u003CFullScan\u003Ek__BackingField = value;
    }

    public bool SortEntriesBeforeSaving
    {
      get => this.\u003CSortEntriesBeforeSaving\u003Ek__BackingField;
      set => this.\u003CSortEntriesBeforeSaving\u003Ek__BackingField = value;
    }

    public bool AddDirectoryWillTraverseReparsePoints
    {
      get => this.\u003CAddDirectoryWillTraverseReparsePoints\u003Ek__BackingField;
      set => this.\u003CAddDirectoryWillTraverseReparsePoints\u003Ek__BackingField = value;
    }
    ...
    {
      get => this.\u003CFlattenFoldersOnExtract\u003Ek__BackingField;
      set => this.\u003CFlattenFoldersOnExtract\u003Ek__BackingField = value;
    }
    ...
    public int MaxOutputSegmentSize
    {
      ...
      set => this._maxOutputSegmentSize = value >= 65536 || value == 0 ? value : throw new ZipException("The minimum acceptable segment size is 65536.");
    }
    ...
    public ICollection<ZipEntry> EntriesSorted
    {
      get
      {
        ZipFile.\u003C\u003Ec__DisplayClass1 cDisplayClass1 = new ZipFile.\u003C\u003Ec__DisplayClass1();
        ...
        cDisplayClass1.sc = this.CaseSensitiveRetrieval ? StringComparison.Ordinal : StringComparison.OrdinalIgnoreCase;
        zipEntryList.Sort(new Comparison<ZipEntry>(cDisplayClass1.\u003Cget_EntriesSorted\u003Eb__0));
      ...
      try
      {
        ...
        else
        {
          ...
          if (this._name != null && (this._temporaryFileName != null || writeStream != null))
          {
            ...
            if (File.Exists(this._name))
            {
              str = this._name + "." + SharedUtilities.GenerateRandomStringImpl(8, 0) + ".tmp";
              if (File.Exists(str))
    ...
    public IEnumerator<ZipEntry> GetEnumerator() => (IEnumerator<ZipEntry>) new ZipFile.\u003CGetEnumerator\u003Ed__3(0)
    {
      \u003C\u003E4__this = this
    };
    ...
    private sealed class \u003C\u003Ec__DisplayClass1
    {
      ...
      public int \u003Cget_EntriesSorted\u003Eb__0(ZipEntry x, ZipEntry y) => string.Compare(x.FileName, y.FileName, this.sc);
    }

    private sealed class \u003CGetEnumerator\u003Ed__3 : 
...
label_6:
      ...
      {
        [DebuggerHidden] get => this.\u003C\u003E2__current;
      }
      ...
      {
        [DebuggerHidden] get => (object) this.\u003C\u003E2__current;
      }

      [DebuggerHidden]
      public \u003CGetEnumerator\u003Ed__3(int _param1) => this.\u003C\u003E1__state = _param1;
