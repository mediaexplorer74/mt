...
label_40:
    ...
    public static string InternalGetTempFileName() => "DotNetZip-" + SharedUtilities.GenerateRandomStringImpl(8, 0) + ".tmp";
    ...
    internal static string GenerateRandomStringImpl(int length, int delta)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        ...
        chArray[index] = (char) (random.Next(26) + delta);
      }
