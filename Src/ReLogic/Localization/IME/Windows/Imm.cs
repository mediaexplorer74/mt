...
// Type: ReLogic.Localization.IME.Windows.Imm
...
namespace ReLogic.Localization.IME.Windows
{
  internal static class Imm
  {
    ...
    public const uint GCS_COMPREADSTR = 1;
    public const uint GCS_COMPREADATTR = 2;
    public const uint GCS_COMPREADCLAUSE = 4;
    public const uint GCS_COMPSTR = 8;
    public const uint GCS_COMPATTR = 16;
    public const uint GCS_COMPCLAUSE = 32;
    public const uint GCS_CURSORPOS = 128;
    public const uint GCS_DELTASTART = 256;
    public const uint GCS_RESULTREADSTR = 512;
    public const uint GCS_RESULTREADCLAUSE = 1024;
    public const uint GCS_RESULTSTR = 2048;
    public const uint GCS_RESULTCLAUSE = 4096;
