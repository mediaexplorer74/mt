  ...
  public class JsonSerializer
  {
    ...
    public virtual System.Runtime.Serialization.SerializationBinder Binder
    {
      get
      {
        ...
        return this._serializationBinder is SerializationBinderAdapter serializationBinder ? serializationBinder.SerializationBinder : throw new InvalidOperationException("Cannot get SerializationBinder because an ISerializationBinder was previously set.");
      }
      set => this._serializationBinder = value != null ? (ISerializationBinder) new SerializationBinderAdapter(value) : throw new ArgumentNullException(nameof (value), "Serialization binder cannot be null.");
    }
