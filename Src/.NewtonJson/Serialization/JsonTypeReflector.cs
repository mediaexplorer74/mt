...
namespace Newtonsoft.Json.Serialization
{
  internal static class JsonTypeReflector
  {
    ...
    public static bool IsNonSerializable(object provider) => JsonTypeReflector.GetCachedAttribute<NonSerializedAttribute>(provider) != null;

    public static bool IsSerializable(object provider) => JsonTypeReflector.GetCachedAttribute<SerializableAttribute>(provider) != null;
