    ...
    internal class SolarSky : CustomSky
    {
        ...
        public override void Update()
        {
            ...
            for (int index = 0; index < _meteors.Length; ++index)
            {
                ...
                if (_meteors[index].Position.Y > Game1.worldSurface * 16.0)
                {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            for (int index = num1; index < num2; ++index)
            {
                ...
                Vector2 position = (_meteors[index].Position - vector2_3) * vector2_1 + vector2_3 - Game1.screenPosition;
        ...
        internal override void Activate(Vector2 position, params object[] args)
        {
            ...
            for (int index = 0; index < _meteors.Length; ++index)
            {
                ...
                _meteors[index].Position.X = (float)(num * (Game1.maxTilesX * 16.0) + Utils.NextFloat(_random) * 40.0 - 20.0);
                _meteors[index].Position.Y = (float)(Utils.NextFloat(_random) * -(Game1.worldSurface * 16.0 + 10000.0) - 10000.0);
